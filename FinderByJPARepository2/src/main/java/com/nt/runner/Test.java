...
//	System.out.println(list6.toString());
	...
	list10.forEach(System.out::println);
		...
		System.out.println("Between method()...........");
		repo.findByPercantageBetween(55.0, 95.0).forEach(System.out::println);
		
		System.out.println("oder() method invoked");
		repo.findBySpecializationInOrderBySpecializationAsc(List.of("Brain","Heart","cardio")).forEach(System.out::println);
	
		System.out.println("In() method invoked");
		repo.findBySpecializationIn(List.of("Brain","Heart","cardio")).forEach(System.out::println);
		System.out.println("GreaterThan() method is invoked");
		repo.findByPercantageGreaterThan(10.0).forEach(System.out::println);
		*/
		System.out.println("And() method invoked");
		repo.findByPercantageGreaterThanAndSpecialization(40.0, "Brain").forEach(System.out::println);
