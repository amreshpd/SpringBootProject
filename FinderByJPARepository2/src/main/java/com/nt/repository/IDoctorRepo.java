...
//	public List<Doctor> showBydocName(String name);
	...
	public List<Doctor> findByPercantageBetween(Double start,Double end);
	public List<Doctor> findBySpecializationInOrderBySpecializationAsc(List<String> specialization);
	public List<Doctor> findBySpecializationIn(List<String> specialization);
	public List<Doctor> findByPercantageGreaterThan(Double start);
	public List<Doctor> findByPercantageGreaterThanAndSpecialization(Double start,String end);
