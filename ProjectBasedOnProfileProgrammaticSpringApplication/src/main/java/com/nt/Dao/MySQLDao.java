...
public class MySQLDao implements IHotelDao{
	 private static final String GET_EMP_INFO="SELECT CITY,HOTELNAME,HOTELRENT,HOTELADDRESS from HOTEL_INFO WHERE CITY IN(?,?,?) ORDER BY CITY";
